...
export default function InstructorSidebar() {
  ...
  return (
    <aside className="w-64 h-screen bg-green-600 text-white flex flex-col justify-between border-r-2 border-white">
      {/* Top */}
      <div>
        <div className="p-6 border-b-2 border-white bg-green-700">
          <h2 className="text-2xl font-bold">Instructor Panel</h2>
          <p className="text-xs text-green-100 mt-1">Course Management</p>
        </div>
