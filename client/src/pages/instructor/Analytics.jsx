...
export default function Analytics() {
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      // Keep existing state (remains zeros) instead of setting mock data
    } finally {
      setLoading(false);
    }
  };
  ...
  const maxRevenue = Math.max(
    ...analytics.monthlyData.map((d) => d.revenue),
    0,
  );
  const maxStudents = Math.max(
    ...analytics.monthlyData.map((d) => d.students),
    0,
  );
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 transition-all duration-300 group hover:shadow-md">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ml-2 ${getGrowthColor(analytics.trends.revenueGrowth)}`}
                    >
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 transition-all duration-300 group hover:shadow-md">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ml-2 ${getGrowthColor(analytics.trends.studentsGrowth)}`}
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 transition-all duration-300 group hover:shadow-md">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-gray-800">
                    {analytics.overview.avgProgress}%
                  </span>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 transition-all duration-300 group hover:shadow-md">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-gray-800">
                    {analytics.overview.satisfactionRate}
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  {analytics.topCourses.map((course, idx) => (
                    <div
                      ...
                      onClick={() =>
                        navigate(`/instructor/course/${course.id}/analytics`)
                      }
                    >
                      ...
                      <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(course.students / analytics.topCourses[0]?.students) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-6 py-5 border-b border-gray-100 bg-orange-50">
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Latest student enrollments and course completions
                </p>
              </div>
